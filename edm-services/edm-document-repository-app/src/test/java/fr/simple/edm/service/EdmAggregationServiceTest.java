...
public class EdmAggregationServiceTest {
	...
	public void suggestionShouldSuggestSomething() throws Exception {
		...
		List<String> topTerms = extractAggregationValueFromAggregationWrapper(edmAggregationsService.getTopTerms(null, "[a-z]{1,2}|[dlmcs]es|data|docs|documents|edm|files|simple|page"));
